 ...
 * <code>ShareActionProviderCustom</code> in the app bar's menu resource. For
 * example:</p>
 *
 * <pre>
 ...
 *      app:actionProviderClass="android.support.v7.widget.ShareActionProviderCustom"/&gt;
 * </pre>
 *
 * <p>You do not need to specify an icon, since the
 * <code>ShareActionProviderCustom</code> widget takes care of its own appearance and
 ...
 *
 * <ol>
 * <li>Get a reference to the ShareActionProviderCustom by calling {@link
 ...
 * ShareActionProviderCustom myShareActionProviderCustom =
 *     (ShareActionProviderCustom) MenuItemCompat.getActionProvider(shareItem);</pre></li>
 *
 ...
 *
 * <pre>
 * myShareActionProviderCustom.setShareIntent(myShareIntent);
 * </pre></li>
 *
 ...
 * myShareActionProviderCustom.setShareIntent(myShareIntent);</pre></li>
 * </ol>
 *
 ...
 * @see ActionProvider
 */
public class ShareActionProviderCustom extends ActionProvider {
    ...
    public interface OnShareTargetSelectedListener {
         ...
         */
        public boolean onShareTargetSelected(ShareActionProviderCustom source, Intent intent);
    }
     ...
     */
    public ShareActionProviderCustom(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public View onCreateActionView() {
        ...
        @SuppressLint("RestrictedApi") ActivityChooserView activityChooserView = new ActivityChooserView(mContext);
     ...
     *         mShareActionProviderCustom.setHistoryFileName(SHARE_IMAGE_HISTORY_FILE_NAME);
     *     } else if (TEXT.equals(intent.getMimeType())) {
     *         mShareActionProviderCustom.setHistoryFileName(SHARE_TEXT_HISTORY_FILE_NAME);
     *     }
     *     mShareActionProviderCustom.setIntent(intent);
        ...
        public boolean onChooseActivity(ActivityChooserModel host, Intent intent) {
            if (mOnShareTargetSelectedListener != null) {
                return mOnShareTargetSelectedListener.onShareTargetSelected(
                        ShareActionProviderCustom.this, intent);
            }
            return false;
        }
    }
